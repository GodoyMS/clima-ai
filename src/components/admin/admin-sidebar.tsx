...
export function AdminSidebar() {
  ...
  return (
    <motion.aside
      ...
      className="relative flex h-full flex-shrink-0 flex-col border-r border-gray-100 bg-white shadow-sm overflow-hidden"
    >
      {/* Logo */}
      <Link
      ...
      <button
        ...
        className={cn(
          "absolute -right-3 top-20 flex h-6 w-6 items-center justify-center rounded-full border border-gray-200 bg-white shadow-sm text-gray-400 hover:text-gray-600 transition-colors z-10",
        )}
      >
        <motion.div
